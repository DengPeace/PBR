...
//    std::cout << "当前工作目录 (Current Working Directory): " << currentWorkingDirectory << std::endl;
//
//    std::cout << "顶点着色器相对路径: " << vertexPath << std::endl;
//    std::cout << "片段着色器相对路径: " << fragmentPath << std::endl;
//
//    // 尝试拼接出绝对路径以供检查（简易方法，并非100%准确但通常有效）
//    std::string potentialVertexPath = std::string(currentWorkingDirectory) + "/" + vertexPath;
//    std::string potentialFragmentPath = std::string(currentWorkingDirectory) + "/" + fragmentPath;
//
//    std::cout << "顶点着色器可能在此绝对路径: " << potentialVertexPath << std::endl;
//    std::cout << "片段着色器可能在此绝对路径: " << potentialFragmentPath << std::endl;
//    // --- 新增调试代码结束 ---
